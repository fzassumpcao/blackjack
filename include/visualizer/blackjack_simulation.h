...
private:
    ...
    const vec2 kBetPos = vec2(980, 420);
    ...
    const vec2 kBetStringPos = vec2(970, 360);
    ...
    const ci::Font kEndRoundMessageFont = ci::Font("georgia", 40);
    const ci::Font kTitleFont = ci::Font("brush script mt", 200);
    const ci::Font kBalanceFont = ci::Font("helvetica", 40);
    const ci::Font kBetFont = ci::Font("helvetica", 30);
